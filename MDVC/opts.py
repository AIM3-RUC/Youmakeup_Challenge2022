...
def parse_opts():
    ...
    parser.add_argument('--cfg_path', type=str, default='cfgs/youMakeUp_i3d_rgb_pdvcl.yml', help='config file')
    ...
    parser.add_argument('--self_iou_loss_coef', default=0, type=float)
