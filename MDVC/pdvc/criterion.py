...
class SetCriterion(nn.Module):
    ...
    def loss_boxes(self, outputs, targets, indices, num_boxes):
        ...
        self_box_iou = box_ops.box_iou(box_ops.box_cl_to_xy(src_boxes),
                                              box_ops.box_cl_to_xy(src_boxes))[0]
        self_iou = torch.triu(self_box_iou, diagonal=1)
        ...
        for i, c in enumerate(self_iou.split(sizes, -1)):
            ...
            if sizes[i] > 1:
                ...
                self_iou_split += torch.tensor(0.0).cuda()
